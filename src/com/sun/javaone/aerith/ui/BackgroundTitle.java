...
class BackgroundTitle extends JComponent {
    ...
    protected void paintComponent(Graphics g) {
        ...
        final Composite composite = g2.getComposite(); {
            ...
            g2.drawImage(titleImage, (getWidth() - titleWidth) / 2, (getHeight() - titleHeight) / 2, null);
    ...
    private Image createTitleImage(Graphics2D g2) {
        ...
        final BufferedImage image = new BufferedImage(getWidth() - 120, (int) bounds.getHeight() + 23, BufferedImage.TYPE_INT_ARGB);
        ...
        int   npoints = 3;
        final Polygon arrow = new Polygon(arrowX, arrowY, npoints);
